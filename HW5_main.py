from module_installer_for_HW5 import installer_main
import numpy , pandas as pd, wx , matplotlib.pyplot as plt, ucimlrepo
import os
...
class Heart_DiseaseVisualizerApp(wx.Frame):
    def __init__(self, parent=None, title="Heart Disease Dataset Visualizer"):
        ...
        open_btn = wx.Button(panel, label="Open Heart Disease Dataset…")
    ...
    def on_open(self, _evt):
        ...
        try:
            ...
            plt.tight_layout()
            plt.show()
            plt.savefig("HW5.png", bbox_inches="tight") 
